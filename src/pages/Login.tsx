  ...
  return (
    <div className="min-h-screen bg-background flex">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            {isLogin
              ...
              : 'Join us and start your AI-powered shopping journey'}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" size="lg" className="btn-premium w-full py-6 gap-2">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-white p-16">
          <motion.div
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-md">
              Get personalized recommendations, price predictions, and smart alerts
